local charConfig = {
	...
	-- 怪物 3v3
	{id = 5001,name = "",skill = nil,speed = 0,collect = nil,radius = 30,maxHp = 1,defaultHp = 1, knockCd = 10,category = 1,attack = 1,res = "resources/role/monster.prefab",icon = "monster"},
