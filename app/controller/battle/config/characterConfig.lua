local charConfig = {
	...
	-- 怪物 3v3
	{id = 5001,name = "",skill = nil,speed = 5,collect = nil,radius = 30,maxHp = 1,defaultHp = 1, knockCd = 10,category = 1,attack = 1,res = "resources/role/monster.prefab",icon = "monster"},
	...
	-- 怪物 endless 
	{id = 5003,name = "",skill = nil,speed = 5,collect = nil,radius = 30,maxHp = 2,defaultHp = 1, knockCd = 10,category = 1,attack = 1,res = "resources/role/monster.prefab",icon = "monster"},
