local charConfig = {
	...
	-- 塔 3v3
	{id = 6001,name = "16",skill ={6001},speed = 0,collect = nil,radius = 60,maxHp = 32,defaultHp = 32, knockCd = 1,category = 1,attack = 16,res = "resources/role/hero_1.prefab",icon = '32'},
	{id = 6002,name = "16",skill ={6002},speed = 0,collect = nil,radius = 60,maxHp = 32,defaultHp = 32, knockCd = 1,category = 1,attack = 16,res = "resources/role/hero_1.prefab",icon = '32'},
