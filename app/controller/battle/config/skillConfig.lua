...
local skillConfig = {
	...
	-- {id = 1001,script = 1001,missileCount = 1,interval = 0,name = "散弹",skillType = 1,target = 1,attackRadius =300,attack = 1,cd = 10},
	-- {id = 1002,script = 1002,missileCount = 1,interval = 0,name = "目标",skillType = 1,target = 1,attackRadius =300,attack = 1,cd = 10},
	...
	{id = 6001,script = 6001,missileCount = 3,interval = 5,name = "远程",skillType = 1,target = 1,attackRadius =300,attack = 1,cd = 50},
	{id = 6002,script = 6002,missileCount = 3,interval = 5,name = "远程",skillType = 1,target = 1,attackRadius =300,attack = 1,cd = 50},
